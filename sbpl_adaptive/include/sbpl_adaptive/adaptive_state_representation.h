...
public:
    ...
    virtual void insertHandrailStates(std::vector<int>& planner_solution) {return;}

    virtual void writeStateDataToFile(const int state_id, const std::string file_name){return;}
